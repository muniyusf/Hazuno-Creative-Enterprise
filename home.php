...
<body>
  ...
  <script>
    ...
    if (messages.length > 0) {
      ...
      messagePopup.textContent = messages[0]; // Display the first message
      messagePopup.classList.add(messages[0].toLowerCase().includes('error') ? 'error' : 'success');
          ...
          <section id="testimonials">
            ...
            <div class="testimonial-box-container">
              ...
              <div class="testimonial-box">
                ...
                <div class="client-comment">
                  <p>Hazuno Creative exceeded my expectations with their personalized designs and top-notch customer support. Their team truly understands what the client needs. Will definitely order again!</p>
                </div>
              </div>
            ...
            <div class="container footer_container">
              ...
              <div class="footer_item">
                ...
                <ul class="footer_list">
                  ...
                  <li class="li footer_list_item"><a href="register.php"></a>Login / Register</li>
